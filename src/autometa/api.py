...
def fetch_metadata(absolute_file_path: str, toml_var: str = "META_TOML"):
    ...
    if absolute_file_path:
        ...
        return automd.get_file_metadata()
    else:
...
def pip_install(absolute_file_path: str, manual_input_list=[], toml_var: str = "META_TOML",
                toml_table_key: str = "project", toml_table_value: str = "dependencies"):
...
def pip_uninstall(absolute_file_path: str, manual_input_list=[], exclusions_list=[], toml_var: str = "META_TOML",
                  toml_table_key: str = "project", toml_table_value: str = "dependencies"):
